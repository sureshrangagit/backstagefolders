...
class KubernetesFanOutHandler {
  ...
  async fanOutRequests(entity, auth, options, objectTypesToFetch, customResources) {
    ...
    const labelSelector = entity.metadata?.annotations?.[pluginKubernetesCommon.KUBERNETES_LABEL_SELECTOR_QUERY_ANNOTATION] || `${pluginKubernetesCommon.KUBERNETES_ANNOTATION}=${entityName}`;
