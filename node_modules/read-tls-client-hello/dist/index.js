...
exports.trackClientHellos = exports.getTlsFingerprintAsJa4 = exports.calculateJa4FromHelloData = exports.getTlsFingerprintAsJa3 = exports.calculateJa3FromFingerprintData = exports.readTlsClientHello = exports.NonTlsError = void 0;
...
function calculateJa4FromHelloData({ serverName, alpnProtocols, fingerprintData }) {
    var _a;
    ...
    const version = extensions.includes(0x002B)
        ...
        : (_a = {
            ...
            0x0302: '11',
            0x0301: '10'
        }[tlsVersion]) !== null && _a !== void 0 ? _a : '00'; // Other unknown version
    ...
    const extensionsStr = extensions
        .filter(e => {
        if (e === 0x0 || e === 0x10)
            return false; // Filter SNI and ALPN
        return !isGREASE(e);
    })
        .sort((a, b) => a - b)
...
exports.calculateJa4FromHelloData = calculateJa4FromHelloData;
function getTlsFingerprintAsJa4(rawStream) {
    return __awaiter(this, void 0, void 0, function* () {
        return calculateJa4FromHelloData((yield readTlsClientHello(rawStream)));
    });
}
...
function trackClientHellos(tlsServer) {
    ...
    tlsServer.on('connection', (socket) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            socket.tlsClientHello = Object.assign(Object.assign({}, helloData), { ja3: calculateJa3FromFingerprintData(helloData.fingerprintData), ja4: calculateJa4FromHelloData(helloData) });
        }
        catch (e) {
