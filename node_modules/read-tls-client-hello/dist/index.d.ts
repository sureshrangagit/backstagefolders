...
export declare function calculateJa4FromHelloData({ serverName, alpnProtocols, fingerprintData }: TlsHelloData): string;
export declare function getTlsFingerprintAsJa4(rawStream: stream.Readable): Promise<string>;
declare module 'tls' {
    interface TLSSocket {
        /**
