...
var _InternalBackdrop2 = require("../../utils/InternalBackdrop");
...
const SelectPositioner = exports.SelectPositioner = /*#__PURE__*/React.forwardRef(function SelectPositioner(props, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_CompositeList.CompositeList, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SelectPositionerContext.SelectPositionerContext.Provider, {
      value: positioner,
      children: [mounted && modal && (_InternalBackdrop || (_InternalBackdrop = /*#__PURE__*/(0, _jsxRuntime.jsx)(_InternalBackdrop2.InternalBackdrop, {}))), renderElement()]
    })
  });
});
