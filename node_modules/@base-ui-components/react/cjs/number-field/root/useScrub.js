...
function useScrub(params) {
  ...
  const getScrubAreaProps = React.useCallback((externalProps = {}) => (0, _mergeProps.mergeProps)({
    role: 'presentation',
    ...
    async onPointerDown(event) {
      ...
      if (!isTouch && !(0, _detectBrowser.isWebKit)()) {
        try {
  ...
  }, externalProps), [readOnly, disabled, onScrubbingChange, inputRef, isScrubbing]);
