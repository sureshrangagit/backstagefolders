...
process.env.NODE_ENV !== "production" ? AvatarImage.propTypes /* remove-proptypes */ = {
   ...
   */
  onLoadingStatusChange: _propTypes.default.func,
  /**
   * @ignore
   */
  referrerPolicy: _propTypes.default.oneOf(['', 'no-referrer-when-downgrade', 'no-referrer', 'origin-when-cross-origin', 'origin', 'same-origin', 'strict-origin-when-cross-origin', 'strict-origin', 'unsafe-url']),
  /**
