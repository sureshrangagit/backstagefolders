...
var _useToolbarInput = require("./useToolbarInput");
 ...
 */const ToolbarInput = exports.ToolbarInput = /*#__PURE__*/React.forwardRef(function ToolbarInput(props, forwardedRef) {
  const {
    className,
  ...
  const {
    getInputProps
  } = (0, _useToolbarInput.useToolbarInput)({
    ref: forwardedRef,
    disabled,
    focusableWhenDisabled
  });
