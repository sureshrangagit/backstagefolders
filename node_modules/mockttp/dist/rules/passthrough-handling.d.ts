...
export declare function getContentLengthAfterModification(body: string | Uint8Array | Buffer, originalHeaders: Headers | RawHeaders, replacementHeaders: Headers | RawHeaders | undefined, mismatchAllowed?: boolean): string | undefined;
