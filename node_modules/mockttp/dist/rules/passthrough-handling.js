...
function getContentLengthAfterModification(body, originalHeaders, replacementHeaders, mismatchAllowed = false) {
    ...
    if ((0, header_utils_1.getHeaderValue)(originalHeaders, 'content-length') === undefined) {
        // Nothing to override - use the replacement value, or undefined
        return (0, header_utils_1.getHeaderValue)(replacementHeaders || {}, 'content-length');
    }
    ...
    const lengthOverride = (0, header_utils_1.getHeaderValue)(replacementHeaders, 'content-length')?.toString();
    ...
    if (lengthOverride === (0, header_utils_1.getHeaderValue)(originalHeaders, 'content-length') &&
