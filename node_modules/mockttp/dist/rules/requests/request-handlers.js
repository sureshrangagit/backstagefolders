    ...
    async handle(clientReq, clientRes, options) {
        ...
        if (this.transformRequest) {
            ...
            if (reqBodyOverride) {
                ...
                const updatedCLHeader = (0, passthrough_handling_1.getContentLengthAfterModification)(reqBodyOverride, clientReq.headers, (updateHeaders && (0, header_utils_1.getHeaderValue)(updateHeaders, 'content-length') !== undefined)
            ...
            serverReq = await makeRequest({
                ...
                if (this.transformResponse) {
                    ...
                    if (resBodyOverride) {
                        ...
                        const updatedCLHeader = (0, passthrough_handling_1.getContentLengthAfterModification)(resBodyOverride, serverRes.headers, (updateHeaders && (0, header_utils_1.getHeaderValue)(updateHeaders, 'content-length') !== undefined)
